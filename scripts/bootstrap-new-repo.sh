...
echo "  3. Create roadmap: cp templates/roadmap-template.md ROADMAP.md"
echo "  4. Create foundation spec in specs/000-foundation/"
echo "  5. Fill in docs/ (PROJECT-CONTEXT, ARCHITECTURE, CODING-STANDARDS, DECISIONS)"
echo "  6. Run: bash .context/scripts/verify-context.sh"
echo "  7. See docs/BOOTSTRAP.md for full instructions (Path A or Path B)"
