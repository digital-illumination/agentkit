...
Write-Host "  3. Create roadmap: cp templates/roadmap-template.md ROADMAP.md"
Write-Host "  4. Create foundation spec in specs/000-foundation/"
Write-Host "  5. Fill in docs/ (PROJECT-CONTEXT, ARCHITECTURE, CODING-STANDARDS, DECISIONS)"
Write-Host "  6. Run: .context/scripts/verify-context.ps1"
Write-Host "  7. See docs/BOOTSTRAP.md for full instructions (Path A or Path B)"
